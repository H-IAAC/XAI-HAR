...
root_dir = Path("../data/har/standartized_balanced")
root_dir_user = Path("../data/har/standartized_balanced_user")
# root_dir_biometric = Path("../datasets/har/standartized_balanced_biometric")
# Location to save the data
output_dir = Path("../data/har/standartized_inter_balanced")
output_dir_user = Path("../data/har/standartized_inter_balanced_user")
# output_dir_biometric = Path("../datasets/har/standartized_inter_balanced_biometric")
